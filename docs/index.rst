...
1. I meet problem installing MySQL-python ( ``mysql_config not found`` ) via pip.for ubuntu users::
...
2.  CURD.py only works with tables which primarykey is generated by MySQL (Such as autoincement priamarykey integer).
